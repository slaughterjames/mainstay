'''
Static v0.4 - Copyright 2023 James Slaughter,
This file is part of Static v0.5.

Static v0.4 is free software: you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.

Static v0.4 is distributed in the hope that it will be useful,
